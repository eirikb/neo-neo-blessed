...
Textarea.prototype.setCursor = function (
  this: TextareaInterface,
  x: number,
  y: number
): void {
...
Textarea.prototype.moveCursor = function (
  this: TextareaInterface,
  x: number,
  y: number
): void {
...
Textarea.prototype.input =
  ...
  Textarea.prototype.readInput =
    function (this: TextareaInterface, callback?: Function) {
      var self = this,
...
Textarea.prototype._listener = function (
  this: TextareaInterface,
  ch: string,
  key: KeyData
): void {
        ...
        if (cursor.x === 0 && cursor.y === 0) {
          ...
          if (fakeLines[fakeLineIndex] === '') {
            ...
            if (currentLine > 0) {
              ...
              cursor.x = -(
                this.strWidth(predict[currentLine - 1] ?? '') - lineLengthBefore
              );
